...
from routers import auth, tenants, locations, reviews, competitors, citations, qa, media, insights, nap, search, notifications, templates, reports, webhooks, activity, billing, widget, campaigns, notification_prefs, public, zernio, admin, gmb, gbp_manage
...
app.include_router(gmb.router, prefix="/api/v1")
app.include_router(gbp_manage.router, prefix="/api/v1")
